...
class AboutSymbols < Neo::Koan
  ...
  # Why is it not a good idea to dynamically create a lot of symbols?
	#
	# Answer
	# Author: david4dev @ http://stackoverflow.com/questions/4573991/
	#
	...
	#	
	#	If you dynamically create lots of symbols, you are allocating a lot of memory that can't be freed until your program ends. You should only dynamically create symbols (using <code>string.to_sym</code>) if you know you will:
	#	
	#	* need to repeatedly access the symbol
	#	* not need to modify them
	#	
	#	As I said earlier, they are useful for things like hashes - where you care more about the <strong>identity</strong> of the variable than its value. Symbols, when correctly used, are a readable and efficient way to pass around identity.
	#	
