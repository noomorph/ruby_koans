...
It was the worst of times.
    ...
    assert_equal 1+25+1+26+1, long_string.length
...
It was the worst of times.
EOS
    assert_equal 25+1+26+1, long_string.length
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # plus equals operator (+=) when building up strings.  Why?
		# 
		# Answer: because it does not create new object,
		# which is efficient in most cases
  end
